  ...
  return (
    <div className="">
      ...
      <div className="flex flex-col space-y-3">
        <button className="p-2 border flex items-center justify-center gap-3 rounded-lg bg-gray-100 hover:bg-gray-200 duration-150">
      ...
      <div className="flex flex-col pt-8">
        ...
        <a
          href="#"
          className="p-4 hover:bg-gray-200 duration-150 border-t-2  border-x-2 flex items-center rounded-t-lg gap-3  bg-gray-100"
        >
          <i className="ri-facebook-circle-fill text-2xl"></i> Facebook
        </a>
        <a
          href="#"
          className="p-4 hover:bg-gray-200 duration-150 border-2 flex items-center  gap-3  bg-gray-100"
        >
          {" "}
        ...
        <a
          href="#"
          className="p-4 hover:bg-gray-200 duration-150 border-b-2 border-x-2 flex items-center gap-3 rounded-b-lg bg-gray-100"
        >
          {" "}
